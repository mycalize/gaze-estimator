...
def show_labels_hist(labels, title, n_bins=20, x_label='gaze_x', y_label='gaze_y'):
  """ Generate a histogram for gaze_x and gaze_y, returns some
  stats for transformed labels """
